...
- **The platform's own till got a screen, because otherwise it had no door.**
  ...
  told Starter allows one _before_ they pick it, and by how much they are over,
...
- **No generated imagery, deliberately.** A generated picture of _this
  client's_ hair reads as a promise about their hair specifically, which is the
