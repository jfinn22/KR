  ...
  return (
    <main>
      ...
      <section className="mx-auto max-w-shell px-6 py-20 lg:px-10 lg:py-28">
        <Badge tone="gold">For colour, correction and extensions salons</Badge>
        ...
        <p className="mt-6 max-w-prose text-pretty text-body text-ink-muted">
          A consultation-first operating system for hair salons. Clients arrive understood, stylists
          arrive prepared, and the front desk stops fixing bookings that should never have been
          made.
        </p>
